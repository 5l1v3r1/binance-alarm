...
def alert_dict():
    ...
    for index in index_list:
        ...
        if percentage_difference < 10:
            ...
            toast.add_actions(label=f"Go to Spot {symbol}", launch=f"https://www.binance.com/en/trade/{symbol}")
            toast.add_actions(label=f"Go to Futures {symbol}", launch=f"https://www.binance.com/en/futures/{symbol}")
